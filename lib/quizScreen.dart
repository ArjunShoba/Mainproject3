...
import 'package:main_project_3/resultscreen.dart';
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:
          AppBar(title: Text('Flutter Quiz'), backgroundColor: Colors.yellow),
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage(
                'assets/images/quizz.jpg'), // Use the correct path of your image here
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color.fromARGB(230, 233, 240, 6),
